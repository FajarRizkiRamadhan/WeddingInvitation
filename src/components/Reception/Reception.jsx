...
export default function Reception() {
  // Target date acara (contoh: 2 November 2025 jam 10:00)
  ...
  const addToGoogleCalendar = () => {
    const title = encodeURIComponent("Wedding Reception Akmal & Marisa");
    const start = "20251102T030000Z"; // UTC format
    const end = "20251102T060000Z"; // UTC format
    const details = encodeURIComponent("Wedding Reception at Rimba Alam Serpong");
    const location = encodeURIComponent("Rimba Alam Serpong, Indonesia");
  ...
  return (
    <section className="min-h-screen w-full flex flex-col items-center justify-center bg-[#E2E0D8] px-6 py-12 text-center">
      ...
      <p className="text-lg font-philosopher text-[#636361]">
        Sunday, 2 November 2025 - 10:00 AM
      </p>
